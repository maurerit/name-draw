 ...
 * parameter: drawId (UUID) - Returns 200 with Participation JSON on success - Returns 400 if
 * cannot join (wrong state, already joined, etc.) - Returns 401 if unauthorized - Returns 404 if
 * draw not found - Participation schema: {id: uuid, draw: Draw, joinedAt: datetime}
 */
